...
(function ($) {
	...
	*/		
    GalleryView = {
        ...
        showNext: function() {
            this.navAction = 'next';
            return this.showItem(this.frameIterator+1);
        },
        ...
        bindActions: function(options) {
            ...
            dom.gv_navWrap.delegate('div','click.galleryview',function(){
                ...
                if(el.hasClass('gv_navNext')) {
                    if (options.callbacks && this.opts.callbacks.imageChanged )
                        options.callbacks.imageChanged.call(self.showNext(), this);
                    else {
                        self.showNext();
                    }
            ...
            dom.gv_panelNavNext.bind('click.galleryview',function(){ 
                ...
                var image= self.showNext(); 
                if (self.opts.callbacks && self.opts.callbacks.imageChanged )
                   self.opts.callbacks.imageChanged.call(window, self.showNext());
                return false;
            });
	...
	*/
    $.fn.galleryView = function (options) {
        if (this.length) {
            ...
            return gallery.init(options,this[0]);
